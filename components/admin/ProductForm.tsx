    ...
    >
      <div className="space-y-6">
        <div className="admin-card space-y-4">
          <h2 className="font-serif text-xl font-light text-green">Details</h2>
          <Input
            label="Product Name"
            {...register("name")}
        ...
        <div className="admin-card space-y-4">
          <h2 className="font-serif text-xl font-light text-green">Pricing & Inventory</h2>
        ...
        <div className="admin-card space-y-4">
          <h2 className="font-serif text-xl font-light text-green">Attributes</h2>
          <Input
            label="Fragrance"
            {...register("fragrance")}
      ...
      <div className="space-y-6">
        <div className="admin-card space-y-4">
          <h2 className="font-serif text-xl font-light text-green">Images</h2>
          {images.length > 0 && (
        ...
        <div className="admin-card space-y-4">
          <h2 className="font-serif text-xl font-light text-green">Visibility</h2>
