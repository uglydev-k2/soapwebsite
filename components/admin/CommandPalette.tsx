  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center bg-black/40 px-4 pt-[12vh]">
      <div
        ...
        aria-hidden
      />
      <div className="relative w-full max-w-xl overflow-hidden border border-green/10 bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between border-t border-green/10 bg-cream/50 px-4 py-2 text-[11px] text-muted">
